...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ initAnimaNumeros)\n/* harmony export */ });\nfunction initAnimaNumeros() {\n  function animaNumeros() {\n    var numerosAnimais = document.querySelectorAll(\"[data-numero]\");\n    numerosAnimais.forEach(function (item) {\n      var quantidade = +item.innerText;\n      var incremento = Math.floor(quantidade / 100);\n      var start = 0;\n      var timer = setInterval(function () {\n        start += incremento;\n        item.innerHTML = start;\n\n        if (start > quantidade) {\n          item.innerHTML = quantidade;\n          clearInterval(timer);\n        }\n      }, 50 * Math.random());\n    });\n  }\n\n  function handleMutation(mutation) {\n    if (mutation[0].target.classList.contains('ativo')) {\n      observer.disconnect();\n      animaNumeros();\n    }\n  }\n\n  var observer = new MutationObserver(handleMutation);\n  var observerTarget = document.querySelector('section.numeros');\n  observer.observe(observerTarget, {\n    attributes: true\n  });\n}\n\n//# sourceURL=webpack://animais-fantasticos/./js/modules/anima-numeros.js?");
